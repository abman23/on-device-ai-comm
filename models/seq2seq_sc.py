...
from .channels import AWGNModel, CDLModel, RealisticModel, FlatFadingModel
...
class TFSeq2SeqSCEncoderChannel(tf.keras.layers.Layer):
    ...
    def __init__(self, 
        ...
        self.bart_encoder.trainable = False
    ...
    def _setup_channel(self, channel_type, ch_config):
        if channel_type == 'AWGN':
            ...
            self.channel_model = FlatFadingModel(
                fec_type=ch_config['fec_type'], 
                channel_num_tx_ant=ch_config['channel_num_tx_ant'],
                channel_num_rx_ant=ch_config['channel_num_rx_ant'],
                num_bits_per_symbol=ch_config['num_bits_per_symbol'],
    ...
    def call(
        ...
        last_hidden_state_pred = replace_nan(last_hidden_state_pred, 0) # convert all NaN values to zero XXX
